"""Hauptfenster von Guardia – PyQt6 Desktop-App.
...
from guardia.config.settings import LlmSettings, load_settings
...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self) -> None:
        ...
        self.setWindowTitle("Guardia – Kleinanzeigen Betrugs-Detektor")
        ...
        # --- Header ---
        header = QLabel("Guardia – Betrugs-Detektor")
    ...
    def _on_template_selected(self, index: int) -> None:
        ...
        if index == 1:
            ...
            # Betrugs-Chat
            path = _TEST_DATA_DIR / "sample_chat_fraud.txt"
            if path.exists():
                self.chat_input.setPlainText(path.read_text(encoding="utf-8").strip())
